...
function LeaveHistory({ leaves, isAdmin, onUpdate }: PropsType) {
                        ...
                        {leave.status === "PENDING" && (
                          <div className="flex justify-center gap-2">
                            <button
                              ...
                              disabled={!!processing}
                              className="p-1.5 rounded-md bg-emerald-50 text-emerald-600 transition-colors"
                            >
                            ...
                            <button
                              ...
                              disabled={!!processing}
                              className="p-1.5 rounded-md bg-rose-50 text-rose-600 transition-colors"
                            >
                              {processing === (leave._id || leave.id) ? (
                                <Loader2 className="size-4 animate-spin" />
                              ) : (
